...
class TCS3472 {
    ...
    /**
     * @brief Read the register of TCS3472 via I2C communication.
     * 
    ...
    /**
     * @brief Read two consecutive registers of TCS3472 via I2C communication.
     * 
     * @param address the address of the lower register
     * @return uint16_t value of the two registers
     */
    uint16_t readRegWord(uint8_t address);
	
    /**
     * @brief Change the register value of TCS3472 via I2C communication.
     * 
     * @param address the address of the register
     ...
     * @param value 
     */
    void setIntegrationTime(uint32_t value);
	...
	private:
		uint32_t intergration_time = TCS3472_INTEGRATIONTIME_2_4MS;
    uint32_t gain = TCS3472_GAIN_1X;
};
